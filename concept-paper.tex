...
\bibitem{b7} Oluwaseun, O. O., \& NAFIU, A. S. Design of Real-Time Voice over Internet Protocol (VOIP) System under Bandwidth Network. Journal homepage: www. ijrpr. com ISSN, 2582, 7421.
...
\bibitem{b13} Warade, A. (2022). Subcontracting the Work in an IT Company: Problems and Solutions.
\bibitem{b14} Han, S., \& Anderson, C. K. (2022). The dynamic customer engagement behaviors in the customer satisfaction survey. Decision Support Systems, 154, 113708.
\bibitem{b15} Aksin, Z., Armony, M., \& Mehrotra, V. (2007). The modern call center: A multi‐disciplinary perspective on operations management research. Production and Operations Management, 16(6), 665-688.
\end{thebibliography}
\vspace{12pt}
\end{document}
